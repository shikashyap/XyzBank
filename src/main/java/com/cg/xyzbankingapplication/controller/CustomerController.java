package com.cg.xyzbankingapplication.controller;
...
import com.cg.xyzbankingapplication.service.TransactionService;
import com.cg.xyzbankingapplication.service.TransactionServiceImpl;
...
//manager login
	...
	public ModelAndView ManagerLogin(@RequestParam String name, @RequestParam String password) {
		...
		if (a.equals("manager") && b.equals("12345")) {
